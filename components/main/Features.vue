                    ...
                    <div class="column is-8 mt-60">
                        ...
                        <article class="media icon-box">
                            <figure class="media-left">
                                <p class="image">
                                    <img src="~assets/img/illustrations/icons/laptop-globe.svg">
                                </p>
                            </figure>
                            <div class="media-content mt-50">
                                <div class="content">
                                    <p>
                                        ...
                                        <span class="icon-box-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ornare magna eros, eu pellentesque tortor.</span>
                                    </p>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="media icon-box">
                            <figure class="media-left">
                                <p class="image">
                                    <img src="~assets/img/illustrations/icons/doc-sync.svg">
                                </p>
                            </figure>
                            <div class="media-content mt-50">
                                <div class="content">
                        ...
                        <article class="media icon-box">
                            <figure class="media-left">
                                <p class="image">
                                    <img src="~assets/img/illustrations/icons/mobile-feed.svg">
                                </p>
                            </figure>
                            <div class="media-content mt-50">
                                <div class="content">
